...
+ (BMKCoordinateRegion) regionForAnnotations:(NSArray*) anns {
    ...
    NSAssert(anns!=nil, @"annotations为空???");
    NSAssert([anns count]!=0, @"annotations 为空???");
...
+ (UIView *)getGoHereViewWithTitle:(NSString *)title
    ...
    UIView *goHereView = [[UIView alloc] initWithFrame:CGRectMake(0,
                                                                  frame.size.height-goHereViewHeigh,
                                                                  frame.size.width,
                                                                  goHereViewHeigh)];
    goHereView.tag             = 990;
    goHereView.backgroundColor = [UIColor colorWithWhite:1.0f alpha:0.8f];
    UILabel *titleLable        = [[UILabel alloc] initWithFrame:CGRectMake(10, 10, goHereView.width-110, 20)];
    titleLable.centerY         = goHereView.height/3;
    ...
    addressLable.centerY       = 2*goHereViewHeigh/3;
    ...
    goHereImage.centerY        = goHereView.height/2;
    goHereImage.image          =[UIImage imageNamed:@"mylocalGo"];
    UILabel *goHereLable       =[[UILabel alloc] initWithFrame:CGRectMake(goHereView.width-50, 10, 50, 20)];
    goHereLable.centerY        = goHereView.height/2;
    goHereLable.text           =@"到这去";
    goHereLable.font           = [UIFont systemFontOfSize:11];
    goHereLable.textColor      = titleLableColor;
    UIView *cutLineView        =[[UIView alloc] initWithFrame:CGRectMake(goHereView.width-85,
                                                                         3,
                                                                         0.5,
                                                                         30)];
    
    cutLineView.backgroundColor = [UIColor colorWithRed:200/255.0f
                                                  green:200/255.0f
                                                   blue:200/255.0f
                                                  alpha:1.0f];
    cutLineView.centerY = goHereView.height/2;
